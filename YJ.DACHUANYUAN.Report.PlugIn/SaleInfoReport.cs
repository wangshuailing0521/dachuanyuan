...
{
    [Description("销售一览表 报表插件")]
    [HotUpdate]
    public class SaleInfoReport : SysReportBaseService
    {
        ...
        public override void BuilderReportSqlAndTempTable(IRptParams filter, string tableName)
        {
            ...
            if (customFilter["FModel"] != null)
            {
                model = customFilter["FModel"].ToString();
            }
            ...
            string sql = $@"EXEC sp_YJ_SaleInfoReport 
               '{programNo}','{model}','{beginYear}','{beginPeriod}','{endYear}','{endPeriod}', '{tempName}'";
